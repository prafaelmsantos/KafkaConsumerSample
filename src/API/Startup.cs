namespace KafkaConsumerSample.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "KafkaConsumerSample.API",
                    Description = "An ASP.NET Core Web API for KafkaConsumerSample",
                    Contact = new OpenApiContact()
                    {
                        Name = "KafkaConsumerSample",
                        Email = "KafkaConsumerSample@gmail.com"
                    },
                    Version = "1.0"
                });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "KafkaConsumerSample.API v1"));
